        ...
        <div class="container mt-5">
            <form id="form" class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <input id="ajouter-email" oninput="ValidInput(this);" type="email" class="form-control" id="inputEmail" required>
                </div>
...
function ValidInput(value){
    ...
    if(!emailPattren.test(value.value)){
...
function GetInput(){
    ...
    const name=document.getElementById("ajouter-name");
    const last=document.getElementById("ajouter-last");
    const email=document.getElementById("ajouter-email");
    const phone=document.getElementById("ajouter-phone");
    const address=document.getElementById("ajouter-address");

    document.getElementById("btn-ajouter").addEventListener('click' ,function(e) {
        let userName=name.value.trim()+last.value.trim();
        ...
        if(!userName , !Email ,!Phone , !Address ,! gender){
            ...
            const contact={username:userName  , Email : Email , phone : Phone ,address : Address , gender:gender};
